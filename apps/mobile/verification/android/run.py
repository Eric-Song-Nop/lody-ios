...
def main():
    ...
    parser.add_argument('--case', choices=['bootstrap', 'wasm', 'recovery', 'storage', 'navigation', 'navigation-interruption', 'navigation-teardown', 'controls', 'menus', 'menu-edges', 'lists', 'list-fonts', 'list-mutations', 'locales', 'locale-switch', 'system', 'feedback', 'feedback-keyboard'], required=True)
    ...
    try:
        ...
        if args.case in ('controls', 'menus', 'menu-edges', 'lists', 'list-fonts', 'list-mutations', 'locales', 'locale-switch', 'system', 'feedback', 'feedback-keyboard'):
