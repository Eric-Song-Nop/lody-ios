...
The observer protocol has a local check: `python3 apps/mobile/verification/android/accessibility_observer_test.py`. This does not establish spoken-label quality or traversal order. The runner is
