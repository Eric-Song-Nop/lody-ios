...
SYSTEM = {
    'en': {'clear': 'Clear text', 'close': 'Close', 'ok': 'OK', 'copy': 'copy', 'paste': 'Paste', 'nextKeyboard': 'Next keyboard'},
    'zh-Hans': {'clear': '清除文本', 'close': '关闭', 'ok': '好', 'copy': '拷贝', 'paste': '粘贴', 'nextKeyboard': '下一个键盘'},
}
