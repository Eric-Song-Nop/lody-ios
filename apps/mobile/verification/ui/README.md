...
| licenses         | Settings sheet + LicensesScreen + LicenseDetailScreen | Alphabetical bundled-library list with license ids and versions, full license text on push, back to the list and sheet close |
