...
| B                     | PR-03 | 生命周期、watchdog 与受控恢复                | PR-02        | [draft #4，本机恢复与回归通过](https://github.com/Eric-Song-Nop/lody-ios/pull/4)             |
| B                     | PR-04 | Keystore、SQLite 与账号上下文恢复            | PR-03        | [draft #4，本机恢复与回归通过](https://github.com/Eric-Song-Nop/lody-ios/pull/4)             |
...
PR-02 已通过真实 bundled JS/WASM 的本机 Android 离线验证及 bootstrap 回归，见[WASM 证据索引](../research/android-wasm-verification.md)。PR-03/04 尚未完成，阶段 B 仍未通过；iOS 原生回归见[签名构建记录](../research/ios-android-regression.md)。
