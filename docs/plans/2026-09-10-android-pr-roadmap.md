...
| B：WASM 数据能力      | PR-02 | 真实 bundled JS/WASM 的离线数据链路          | PR-01        | [draft #3，Android 离线验证通过，iOS 回归中](https://github.com/Eric-Song-Nop/lody-ios/pull/3) |
...
PR-02 已通过真实 bundled JS/WASM 的本机 Android 离线验证及 bootstrap 回归，见[WASM 证据索引](../research/android-wasm-verification.md)。PR-03/04 尚未完成，阶段 B 仍未通过；iOS 原生回归仍需完成。
